...
export default function Navbar() {
  return (
    <div className="pt-6">
      <div className="  bg-white rounded-xl mx-6  px-4 pt-4 pb-6  flex justify-between items-center">
        <div className="flex items-center gap-1">
          <Image src={"/Logo.svg"} width={26.67} height={26.67} alt="logo" />
          <Image
            src={"/devlinks.svg"}
            width={108}
            height={21}
        ...
        {/* This is the middle part of the navbar */}

        <div className="flex justify-center gap-4 items-center">
          <Link
            href={"#"}
            className="flex px-[27px] text-deep_blue py-[11px] rounded-lg bg-norm_ash gap-2 justify-center items-center">
            <Image src={"/lock.svg"} width={15.63} height={15.63} alt="" />
            <p className="font-semibold"> Links </p>
          </Link>

          <Link
            href={"#"}
            className="flex px-[27px] group py-[11px] rounded-lg justify-center gap-2 items-center">
            <svg
              className=" group-hover:fill-deep_blue fill-[#737373]"
              width="17"
              height="18"
              viewBox="0 0 17 18"
              fill="currentColor"
            ...
            <p className="group-hover:text-deep_blue text-deep_ash font-semibold">
              Profile Details
            </p>
          </Link>
        </div>
        <div>
          <button className=" border border-deep_blue text-deep_blue py-3 px-7 rounded-lg font-semibold hover:bg-light_purp">
            Preview
          </button>
        </div>
      </div>
